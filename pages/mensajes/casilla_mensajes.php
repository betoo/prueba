...
?>
                    ...
                    <div class="mailbox row">
                        <div class="col-xs-12">
                            <div class="box box-solid">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-3 col-sm-4 box_msj">
                                            ...
                                            <!-- compose message btn -->
                                            <a class="btn btn-block btn-primary" data-toggle="modal" data-target="#compose-modal"><i class="fa fa-pencil"></i> Crear Mensaje</a>
                                            <!-- Navigation - folders-->
                                            <div style="margin-top: 15px;">
                                                <ul class="nav nav-pills nav-stacked">
                                                    <li class="header">Carpetas</li>
                                                    <li class="active msj_recibidos"><a href="#"><i class="fa fa-inbox"></i> Recibidos(14)</a></li>
                                                    <li><a href="#"><i class="fa fa-mail-forward"></i> Enviados</a></li>
                                                </ul>
                                            </div>
                                        </div><!-- /.col (LEFT) -->
                                        <div class="col-md-9 col-sm-8 content_msj">
                                            <div class="row pad ">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="table-responsive ">
                                                ...
                                                <table class="table table-mailbox ">
                                                    <tr class=" msj">
                                                        <a href="detalle_mensaje.php">
                                                            <td class="small-col"><input type="checkbox" /></td>
                                                            <td class="small-col"><i class="fa fa-star"></i></td>
                                                            <td class="name">John Doe</td>
                                                            <td class="subject">Urgent! Please read</td>
        ...
        <script src="<?php echo "http://" . $_SERVER['SERVER_NAME'] .'/maketa/'; ?>/js/AdminLTE/demo.js" type="text/javascript"></script>
        <!-- Bootstrap WYSIHTML5 -->
        <script src="<?php echo "http://" . $_SERVER['SERVER_NAME'] .'/maketa/'; ?>/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
        <!-- iCheck -->
        <script src="<?php echo "http://" . $_SERVER['SERVER_NAME'] .'/maketa/'; ?>/js/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
        <!-- Page script -->
