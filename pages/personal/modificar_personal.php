...
?>
            ...
            <aside class="right-side">
                ...
                <div class="col-md-12">
                    <div class="box box-warning cliente-box">
                        <div class="box-header">
                            <h3 class="box-title">Modificar Personal</h3>
                        </div>
                        <div class="box-body">
                            <div class="col-md-6">
                                <form role="form">
                ...
                <form action="lista_personal.php">
                    <button class="btn btn-primary btn-right btn-margin btn-lg" onclick="confirm('¿Desea modificar el regitro?');">Modificar</button>
